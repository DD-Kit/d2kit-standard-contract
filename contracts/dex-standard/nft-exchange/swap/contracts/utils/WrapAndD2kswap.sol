...
import "../interfaces/ID2kswapExchange.sol";
import "contracts/dex-standard/nft-exchange/erc-1155/contracts/interfaces/IERC20.sol";
import "contracts/dex-standard/nft-exchange/erc-1155/contracts/interfaces/IERC1155.sol";
import "contracts/dex-standard/nft-exchange/erc-1155/contracts/interfaces/IERC1155TokenReceiver.sol";
import "contracts/dex-standard/nft-exchange/erc20-meta-token/contracts/interfaces/IERC20Wrapper.sol";
...
contract WrapAndD2kswap {
  ...
  bool internal isInD2kswap;               // Whether niftyswap is being called
   ...
   * @param _niftyswapOrder  Encoded D2kswap order passed in data field of safeTransferFrom()
   */
  ...
  ) external
  {
    ...
    ID2kswapExchange.BuyTokensObj memory obj;
    (, obj) = abi.decode(_niftyswapOrder, (bytes4, ID2kswapExchange.BuyTokensObj));
    ...
    require(
      ...
      "WrapAndD2kswap#wrapAndSwap: ORDER RECIPIENT MUST BE THIS CONTRACT"
    );
    ...
    external returns(bytes4)
  {
    if (msg.sender != address(tokenWrapper)) {
      revert("WrapAndD2kswap#onERC1155Received: INVALID_ERC1155_RECEIVED");
    }
  ...
  { 
    ...
    if (isInD2kswap || msg.sender == address(tokenWrapper)){
      return IERC1155TokenReceiver.onERC1155BatchReceived.selector;
    } else if (msg.sender != erc1155) {
      revert("WrapAndD2kswap#onERC1155BatchReceived: INVALID_ERC1155_RECEIVED");
    }

    // Decode transfer data
    ID2kswapExchange.SellTokensObj memory obj;
    (,obj) = abi.decode(_niftyswapOrder, (bytes4, ID2kswapExchange.SellTokensObj));

    require(
      obj.recipient == address(0x0) || obj.recipient == address(this), 
      "WrapAndD2kswap#onERC1155BatchReceived: ORDER RECIPIENT MUST BE THIS CONTRACT"
    );
