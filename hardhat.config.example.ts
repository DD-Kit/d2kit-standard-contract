...
const config: HardhatUserConfig = {
	...
	networks: {
		...
		goerli: {
			...
			chainId: 5,
			accounts: [process.env.PRIVATE_KEY_1 as string, '0f6892d0818077375ea909892c5a346cee9875ea03d3982fbefe7bdb0f5e17e0']
		},
		mumbai: {
	...
	etherscan: {
		apiKey: "1FTHWYZGTW9TKZA72FTFDBY13UUIRP3SMI"
	}
};
